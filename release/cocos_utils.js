...
define("base/core/Test", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Test {
        static test(title, execFuncs) {
            console.log("====================>\n");
...
define("base/core/Base", ["require", "exports", "base/core/Test"], function (require, exports, Test_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Base {
    ...
    Test_1.Test.test("UWordX64", [
        () => {
            ...
            function create(args) {
                let obj = new Object();
                let arr = [];
                let Con = arr.shift.call(arguments);
            ...
            child.sayAge();
            console.log("构造器原型链");
            console.log("Child.prototype === Parent:", Child.prototype === Parent);
...
define("base/encoder/EncoderHex", ["require", "exports", "base/core/WordArray"], function (require, exports, WordArray_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class EncoderHex {
    ...
    exports.EncoderHex = EncoderHex;
    ;
});
define("base/core/WordArray", ["require", "exports", "base/core/Base", "base/encoder/EncoderHex", "base/core/Test"], function (require, exports, Base_1, EncoderHex_1, Test_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class WordArray extends Base_1.Base {
        ...
        toString(encoder = EncoderHex_1.EncoderHex) {
    ...
    Test_2.Test.test("UWordArray", [() => {
            ...
            let val1 = EncoderHex_1.EncoderHex.parse(str1);
            let val2 = EncoderHex_1.EncoderHex.parse(str2);
...
define("base/encoder/EncoderBase64", ["require", "exports", "base/core/WordArray", "base/core/Test"], function (require, exports, WordArray_2, Test_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function parseLoop(base64Str, base64StrLength, reverseMap) {
        ...
        return new WordArray_2.WordArray(words, nBytes);
    }
    class EncoderBase64 {
        static stringify(wordArray) {
            let words = wordArray.words;
    ...
    EncoderBase64._reverseMap = [];
    exports.EncoderBase64 = EncoderBase64;
    ;
    Test_3.Test.test("UBase64", [
        () => {
            let str = "hello, world!;;你好, 世界！";
        }
    ]);
});
define("base/encoder/EncoderLatin1", ["require", "exports", "base/core/WordArray"], function (require, exports, WordArray_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class EncoderLatin1 {
        static stringify(wordArray) {
        ...
        static parse(latin1Str) {
            ...
            return new WordArray_3.WordArray(words, latin1StrLength);
        }
    }
    exports.EncoderLatin1 = EncoderLatin1;
    ;
});
define("base/encoder/EncoderUtf8", ["require", "exports", "base/encoder/EncoderLatin1"], function (require, exports, EncoderLatin1_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class EncoderUtf8 {
        static tringify(wordArray) {
            try {
                return decodeURIComponent(escape(EncoderLatin1_1.EncoderLatin1.stringify(wordArray)));
            }
            catch (e) {
        ...
        static parse(utf8Str) {
            return EncoderLatin1_1.EncoderLatin1.parse(unescape(encodeURIComponent(utf8Str)));
        }
    }
    exports.EncoderUtf8 = EncoderUtf8;
    ;
});
define("cu.All", ["require", "exports", "base/encoder/EncoderBase64", "base/encoder/EncoderUtf8"], function (require, exports, EncoderBase64_1, EncoderUtf8_1) {
    "use strict";
    function __export(m) {
        for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
    }
    Object.defineProperty(exports, "__esModule", { value: true });
    __export(EncoderBase64_1);
    __export(EncoderUtf8_1);
});
...
define("base/core/BufferedBlockAlgorithm", ["require", "exports", "base/core/Base", "base/core/WordArray", "base/encoder/EncoderUtf8"], function (require, exports, Base_2, WordArray_4, EncoderUtf8_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BufferedBlockAlgorithm extends Base_2.Base {
        constructor() {
            super(...arguments);
            this.blockSize = 0;
        ...
        _doProcessBlock(...args) {
        }
        reset() {
            this._data = new WordArray_4.WordArray();
            this._nDataBytes = 0;
        }
        _append(data) {
            if (typeof data == 'string') {
                data = EncoderUtf8_2.EncoderUtf8.parse(data);
            }
        ...
        _process(doFlush) {
            ...
            return new WordArray_4.WordArray(processedWords, nBytesReady);
        }
        clone() {
...
define("base/core/Hasher", ["require", "exports", "base/core/Base", "base/core/BufferedBlockAlgorithm", "base/algo/AlgoHMAC"], function (require, exports, Base_3, BufferedBlockAlgorithm_1, AlgoHMAC_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Hasher extends BufferedBlockAlgorithm_1.BufferedBlockAlgorithm {
        constructor(cfg) {
            super(arguments);
            this.cfg = new Base_3.Base();
        ...
        _createHelper(hasherClass) {
            return function (message, cfg) {
                return new hasherClass(cfg).finalize(message);
            };
        }
        _createHmacHelper(hasherClass) {
            return function (message, key) {
                return new AlgoHMAC_1.AlgoHMAC(hasherClass, key).finalize(message);
            };
        }
    }
    exports.Hasher = Hasher;
});
define("base/algo/AlgoHMAC", ["require", "exports", "base/core/Base", "base/encoder/EncoderUtf8"], function (require, exports, Base_4, EncoderUtf8_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class AlgoHMAC extends Base_4.Base {
        constructor(hasherClass, key) {
            super(arguments);
            this._hasher = null;
            this._oKey = null;
            this._iKey = null;
            ...
            if (typeof key == 'string') {
                key = EncoderUtf8_3.EncoderUtf8.parse(key);
            }
    ...
    exports.AlgoHMAC = AlgoHMAC;
    ;
});
define("base/algo/AlgoMD5", ["require", "exports", "base/core/Hasher", "base/core/WordArray"], function (require, exports, Hasher_1, WordArray_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let T = [];
    (function () {
    ...
    class MD5 extends Hasher_1.Hasher {
        constructor() {
            super(...arguments);
            this._hash = null;
        }
        _doReset() {
            this._hash = new WordArray_5.WordArray([
        ...
        clone() {
            let clone = this.clone.call(this);
...
define("base/core/WordX64", ["require", "exports", "base/core/Base", "base/core/Test"], function (require, exports, Base_5, Test_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class WordX64 extends Base_5.Base {
    ...
    exports.WordX64 = WordX64;
    ;
    Test_4.Test.test("WordX64", [
        () => {
...
define("base/core/WordX64Array", ["require", "exports", "base/core/Base", "base/core/WordX64", "base/core/WordArray", "base/core/Test"], function (require, exports, Base_6, WordX64_1, WordArray_6, Test_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UWordX64Array extends Base_6.Base {
        constructor(words, sigBytes) {
            super(arguments);
            this.words = null;
            this.sigBytes = 0;
        ...
        toX32() {
            ...
            return new WordArray_6.WordArray(x32Words, this.sigBytes);
        }
        clone() {
    ...
    exports.UWordX64Array = UWordX64Array;
    ;
    Test_5.Test.test("UWordX64Array", [
        () => {
            let wordArray1 = new UWordX64Array([
                new WordX64_1.WordX64(0x00010203, 0x04050607),
                new WordX64_1.WordX64(0x18191a1b, 0x1c1d1e1f)
            ]);
...
define("base/crypto/USerial", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class USerial {
...
define("base/encoder/EncoderUtf16BE", ["require", "exports", "base/core/WordArray"], function (require, exports, WordArray_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class EncoderUtf16BE {
        ...
        static parse(utf16Str) {
            ...
            return new WordArray_7.WordArray(words, utf16StrLength * 2);
        }
    }
    exports.EncoderUtf16BE = EncoderUtf16BE;
    ;
});
define("base/encoder/EncoderUtf16LE", ["require", "exports", "base/core/WordArray"], function (require, exports, WordArray_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class EncoderUtf16LE {
        static swapEndian(word) {
            return ((word << 8) & 0xff00ff00) | ((word >>> 8) & 0x00ff00ff);
        }
        static stringify(wordArray) {
            let words = wordArray.words;
        ...
        static parse(utf16Str) {
            ...
            return new WordArray_8.WordArray(words, utf16StrLength * 2);
        }
    }
    exports.EncoderUtf16LE = EncoderUtf16LE;
    ;
});
define("base/helper/CipherParams", ["require", "exports", "base/core/Base"], function (require, exports, Base_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class CipherParams extends Base_7.Base {
...
define("base/format/FormatHex", ["require", "exports", "base/helper/CipherParams", "base/encoder/EncoderHex"], function (require, exports, CipherParams_1, EncoderHex_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class FormatHex {
        static stringify(cipherParams) {
            return cipherParams.ciphertext.toString(EncoderHex_2.EncoderHex);
        }
        static parse(input) {
            let ciphertext = EncoderHex_2.EncoderHex.parse(input);
...
define("base/parser/ULZW", ["require", "exports", "base/core/Test"], function (require, exports, Test_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("base/parser/Xml", ["require", "exports", "base/core/Test"], function (require, exports, Test_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let DOMNodeTypes = {
        ELEMENT_NODE: 1,
    ...
    Test_7.Test.test("UXml", [
        ...
        () => {
            ...
            let xmlDocStr8 = x2js8.json2xml_str(testObjC8);
...
define("base/struct/CircularLinkedList", ["require", "exports", "base/core/Test"], function (require, exports, Test_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ListNode {
        constructor(element) {
    ...
    Test_8.Test.test("CircularLinkedList", [
        () => {
...
define("base/struct/Dictionary", ["require", "exports", "base/core/Base", "base/core/Test"], function (require, exports, Base_8, Test_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Dictionary {
        constructor() {
        ...
        values() {
            return Base_8.Base.values(this.items);
        }
        getItems() {
            return this.items;
        }
    ...
    Test_9.Test.test("Dictionary", [
        () => {
            ...
            console.log(dictionary1.has('Gandalf'));
            console.log(dictionary1.size);
            console.log(dictionary1.keys());
            console.log(dictionary1.values());
            console.log(dictionary1.get('Tyrion'));
            dictionary1.delete('John');
            console.log(dictionary1.keys());
            console.log(dictionary1.values());
            console.log(dictionary1.entries());
        }
    ]);
});
...
define("base/struct/RBush", ["require", "exports", "base/core/Test"], function (require, exports, Test_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class RBush {
...
define("base/struct/Set", ["require", "exports", "base/core/Base"], function (require, exports, Base_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Set {
        constructor() {
        ...
        values() {
            return Base_9.Base.values(this.items);
        }
        union(otherSet) {
...
define("base/type/Array1", ["require", "exports", "base/core/Base"], function (require, exports, Base_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UArray1 {
        ...
        copy(arr1) {
            ...
            for (let i = 0; i < data.length; i++) {
                let item = data[i];
                if (item) {
                    let copyItem = Base_10.Base.deepCopy(item);
...
define("base/type/Array2", ["require", "exports", "base/core/Base"], function (require, exports, Base_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UArray2 {
            ...
            for (let j = 0; j < data.length; j++) {
                ...
                if (items) {
                    ...
                    for (let i = 0; i < items[j]; i++) {
                        let item = items[i];
                        let copyItem = Base_11.Base.deepCopy(item);
...
define("base/type/String", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class String {
        constructor(str) {
...
define("base/type/Tool", ["require", "exports", "base/core/Test"], function (require, exports, Test_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Tool {
...
define("base/type/UCRC32", ["require", "exports", "base/core/Test"], function (require, exports, Test_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.UCRC32 = UCRC32;
    ;
    Test_12.Test.test("CRC32", [
        () => {
            console.log(UCRC32.str("SheetJS"));
            console.log(UCRC32.bstr("SheetJS"));
            console.log(UCRC32.buf([83, 104, 101, 101, 116, 74, 83]));
            let crc32 = UCRC32.buf([83, 104]);
            console.log("str1:", crc32);
            crc32 = UCRC32.str("eet", crc32);
            console.log("str2:", crc32);
            crc32 = UCRC32.bstr("JS", crc32);
            console.log("str2:", crc32);
        }
    ]);
});
...
define("utils/Audio", ["require", "exports", "base/storage/Storage", "base/core/Base"], function (require, exports, Storage_1, Base_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        getAudioObj() {
            if (!this.audioObj._inited) {
                ...
                if (!str) {
                    ...
                    Base_12.Base.merge(this.audioObj, audioObj);
                    this.audioObj._inited = true;
                }
            }
...
define("utils/Sign", ["require", "exports", "base/storage/Storage", "base/core/Base"], function (require, exports, Storage_2, Base_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        getSignObj() {
            if (!this.signObj._inited) {
                ...
                if (!str) {
                    ...
                    Base_13.Base.merge(this.signObj, signObj);
                    this.signObj._inited = true;
                }
            }
            return this.signObj;
...
define("utils/User", ["require", "exports", "base/storage/Storage", "base/core/Base"], function (require, exports, Storage_3, Base_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        getUserObj() {
            if (!this.userObj._inited) {
                ...
                if (str) {
                    ...
                    Base_14.Base.merge(this.userObj, userObj);
                    this.userObj._inited = true;
                }
            }
            return this.userObj;
