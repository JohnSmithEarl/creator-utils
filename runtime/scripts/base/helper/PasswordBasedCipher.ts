...
export class PasswordBasedCipher extends SerializableCipher {
     ...
     */
    static cfg: any = new SerializableCipher.cfg({
        kdf: OpenSSLKdf
    })
     ...
     * @example
     *
     *     var plaintext = PasswordBasedCipher.decrypt(CryptoJS.algo.AES, formattedCiphertext, 'password', { format: CryptoJS.format.OpenSSL });
     *     var plaintext = PasswordBasedCipher.decrypt(CryptoJS.algo.AES, ciphertextParams, 'password', { format: CryptoJS.format.OpenSSL });
     */
