...
export class UGraph {
     ...
     * @param handler 
     */
    public static breadthFirstTraversal(graph: UGraph, startVertex: any, handler: Function) {
        let vertices = graph.getVertices();
        let adjList = graph.getAdjList();
        let color = {};
        vertices.forEach(v => color[v] = COLORS.WHITE);
        let queue = new UQueue();
     ...
     * @param startVertex 
     */
    public static breadthFirstSearchPath(graph: UGraph, startVertex: any) {
        let vertices = graph.getVertices();
        let adjList = graph.getAdjList();
        let color = {};
        vertices.forEach(v => color[v] = COLORS.WHITE);
...
export let test = function () {
    ...
    console.log("\n\n 广度优先遍历");
    UGraph.breadthFirstTraversal(graph, 'A', (value: any) => console.log(`visited vertex: ${value}`));
}