...
//         seconds = mDate.getSeconds(); //    //绝对时间,从1970.1.1开始的毫秒数
//     var absoluteTime = ((isDate(targetDate)) ? targetDate.getTime() : parseInt(targetDate)) || 0;
...
//     } else {
//         throw 'UtilDate Constructor Error!';
//     }
// };
...
// };
// UtilDate.prototype.isDate = isDate;
...
//         var self = this;
//         return new UtilDate(cloneDate(this.myDate, function (mDate, year, month, date, hours, minutes, seconds) {
...
//     clone: function () {
//         return new UtilDate(cloneDate(this.myDate));
//     },
...
//         if (!isDate(targetDate) && !(targetDate instanceof UtilDate)) {
//             return -1;
//         }
//         //默认为毫秒
//         pattern = pattern || 'iii';
